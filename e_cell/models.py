...
class StartUp(db.Model):
	...
	poc_name = db.Column(db.String(30),nullable=False)
	poc_email = db.Column(db.String,nullable=False)
	poc_phone_no= db.Column(db.Integer,nullable=False)
	...
	def __repr__(self):
	    ...
	    return f"StartUp('{self.startup_name}', '{self.poc_name}', '{self.poc_email}','{self.poc_phone_no}','{self.incentive}','{self.duration}','{self.website}')"
